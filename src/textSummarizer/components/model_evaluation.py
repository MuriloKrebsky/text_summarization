...
class ModelEvaluation:
    ...
    def calculate_metric_on_test_ds(self, dataset, metric, model, tokernizer,
        ...
        for article_batch, target_batch in tqdm(
            ...
            decoded_summaries = [tokenizer.decode(
                summary, skip_special_tokens=True, clean_up_tokenization_spaces=True)for summary in summaries
            ]
    ...
    def evaluate(self):
        ...
        dataset_samsum_pt = load_from_disk(self.config_data_path)
